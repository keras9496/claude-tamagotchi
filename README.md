...
- **상태창 하단 버튼** — 🙈 **넣어두기**(펫을 잠시 숨김) · 🔄 **재시작**(코드 변경 반영). 넣어두면 작은 **미니 독**이 떠서 🐾 **꺼내기**로 다시 부를 수 있고, 미니 독은 **바탕을 끌어 원하는 위치로** 옮길 수 있습니다.
...
│   ├── status.*     상태·인터랙션 패널 (게이지 + 밥주기/놀아주기 + 넣어두기/재시작)
│   └── mini.*       넣어두기 시 뜨는 미니 독 (꺼내기/재시작 · 드래그 이동)
├── package.json
├── LICENSE
└── README.md
```
